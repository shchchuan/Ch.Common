    ...
    public class WxPayData
    {
        ...
        */
        public string MakeSign(string signType)
        {
            ...
            string str = ToUrl();
            //在string后加入API KEY
            str += "&key=" + WxConfig.WxPayKey;
            Log.WriteLog("MakeSign", str);
            if (signType == SIGN_TYPE_MD5)
            {
                ...
                Log.WriteLog("MakeSign", "SIGN_TYPE_MD5:" + sb.ToString().ToUpper());
                //所有字符转为大写
                return sb.ToString().ToUpper();
            }
            else if (signType == SIGN_TYPE_HMAC_SHA256)
            {
                string res = CalcHMACSHA256Hash(str, WxConfig.WxPayKey);
                Log.WriteLog("MakeSign", "SIGN_TYPE_HMAC_SHA256:" + res);
                return res;
            }
            else
            {
        ...
        */
        public bool CheckSign(string signType)
        {
            ...
            Log.WriteLog(this.GetType().ToString(), "WxPayData签名验证错误!");
