    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            {
                inputObj.SetValue("notify_url", WxConfig.WxPayNotice);//异步通知url
            }
	    ...
	    */
        ...
        {
            //如果不需要进行上报
            if (WxConfig.ReportLevel == 0)
            {
                return;
            }

            //如果仅失败上报
            if (WxConfig.ReportLevel == 1 && inputObj.IsSet("return_code") && inputObj.GetValue("return_code").ToString() == "SUCCESS" &&
